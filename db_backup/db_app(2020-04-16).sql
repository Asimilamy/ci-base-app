...
CREATE TABLE `code_generator_parts`  (
  ...
  `part` varchar(50) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `value` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NULL DEFAULT NULL,
  `separator` char(8) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
CREATE TABLE `code_generators`  (
  ...
  `column` varchar(50) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `format` text CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `on_reset` char(25) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
